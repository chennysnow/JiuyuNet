<%@ Page Language="C#" MasterPageFile="../MasPageAdmin.master" AutoEventWireup="true" CodeFile="link.aspx.cs" Inherits="admin_link" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
 <asp:Panel ID="PanelRep" runat="server">
      分类查看:<asp:DropDownList ID="dropBin" runat="server" Width="200px" 
            ...
            <asp:ListItem Value="bottom">底部链接</asp:ListItem>
            <asp:ListItem Value="top">顶部链接</asp:ListItem>
            </asp:DropDownList><br />
