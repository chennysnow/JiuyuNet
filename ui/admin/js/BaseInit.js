...
$(document).ready(function () {
    ...
    myMask = new Ext.LoadMask(Ext.get("frame_0"), { msg: "Please wait..." });
    ...
    tree.on('itemclick', function (view, record, item, index, e, eOpts) {
        ...
        if (!record.hasChildNodes()) {
            ...
            if (mainPanel.items.containsKey(tabid)) {
                ...
                var iframe_html = "<iframe id='frame_0' frameborder='0' height='100%' width='100%' src='" + record.data.href.replace("#!", "") + "'/>";
                mainPanel.add({
                    id: tabid,
                    //                            contentEl: 'center1',
                    ...
                    loader: { loadMask: "loading", autoLoad: false, url: record.data.href.replace("#!", ""), scripts: true },
                    autoScroll: true,
                    listeners: {
                        beforeactivate: function (a) {
//                            var myMask = new Ext.LoadMask(Ext.get("frame_0"), { msg: "Please wait..." });
                            myMask.show();
                            alert("aaa");
