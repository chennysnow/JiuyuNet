<%@ Page Language="C#" MasterPageFile="../MasPageAdmin.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="admin_news_Edit" Title="无标题页" %>
         ...
         <tr>
            ...
            <tr>
                <td class="style1">
                    静态名称:</td>
                <td class="style3">
                    <asp:TextBox ID="txtHtmlName" runat="server" MaxLength="180" Width="200px"></asp:TextBox>
                    <font color="red" id="inspection"></font> <a href="javascript:htmlName('<%=txtHtmlName.ClientID %>')">检测</a>
                    <input type="checkbox" checked="checked" id="showC" value="1" runat="server"  />显示
                    </td>
            </tr>
            <tr>
                <td class="style1">
