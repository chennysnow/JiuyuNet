<%@ Page Title="" Language="C#" MasterPageFile="../MasPageAdmin.master" AutoEventWireup="true" CodeFile="attrList.aspx.cs" Inherits="admin_product_attrList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <td><input type="text" name="nameC" value="<%# Eval("name") %>" /></td>
    <td><input type="text" name="valueC" value="<%# Eval("value") %>" style="width:500px" /></td>
    <td class="sort">
