<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasPageAdmin.master" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="admin_supply_edit" %>
...
<%--            <tr>
           ...
           <tr>
                <td class="style1">
                                        联系人:</td>
                <td class="style3">
                    <asp:TextBox ID="TextBox1" runat="server" MaxLength="180" Width="360px"></asp:TextBox>
                    </td>
            </tr>
            <tr>
                <td class="style1">
            ...
            <td class="style1">自定义属性:</td>
                <td class="style3">
                 ...
                 <li><div style=" width:150px; overflow:hidden;">
                   ...
                   <input type="checkbox" name="attr" <%# Eval("types").ToString()=="1"?"checked=\"checked\"":"" %> value="<%# Eval("id") %>"/><%# Eval("name") %>
