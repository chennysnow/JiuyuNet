...
public partial class admin_Report_VisitorsReport : System.Web.UI.Page
{
    ...
    //    VisitorsReportDB itemdb = new VisitorsReportDB();
    //    string where = " where CreateDate BETWEEN '" + date.ToShortDateString() + "' And '" + date.AddDays(1).ToShortDateString() + "'";
    //    string sql = "SELECT DATE_FORMAT(CreateDate,'%Y-%m-%d %H') AS 'CreateDate',COUNT(1) as 'Quantity', ProductName  from `visitorsreport`  " + where + "  GROUP BY DATE_FORMAT(CreateDate,'%Y-%m-%d %H'),ProductName";
    //    DataTable dt = VisitorsReportDB.SqlTable(sql);
    //    if (dt == null)
    //        return;
    ...
    //        c.Value = data;
    //        c.Key = dt.Rows[i]["ProductName"].ToString();
    //        bool fg = true;
    ...
    //            if (col[j].Key == c.Key)
    //            {
    //                col[j].Value[DateTime.Parse(dt.Rows[i]["CreateDate"].ToString()).Hour.ToString()] = (Decimal.Parse(col[j].Value[DateTime.Parse(dt.Rows[i]["CreateDate"].ToString()).Hour.ToString()]) + int.Parse(dt.Rows[i]["Quantity"].ToString())).ToString();
    //                fg = false;
    //            }
    //        }
    ...
    //        if (i == 0 || fg)
    //        {
    //            data[DateTime.Parse(dt.Rows[i]["CreateDate"].ToString() + ":00:00").Hour.ToString()] = (Decimal.Parse(data[DateTime.Parse(dt.Rows[i]["CreateDate"].ToString() + ":00:00").Hour.ToString()]) + int.Parse(dt.Rows[i]["Quantity"].ToString())).ToString();
    //            col.Add(c);
    ...
    //    string sql = "SELECT DATE_FORMAT(CreateDate,'%Y-%m-%d') AS 'CreateDate',COUNT(1) as 'Quantity', ProductName  from `visitorsreport`  " + where + "  GROUP BY DATE_FORMAT(CreateDate,'%Y-%m-%d'),ProductName";
    ...
    //            if (col[j].Key == c.Key)
    //            {
    //                col[j].Value[dt.Rows[i]["CreateDate"].ToString()] = (Decimal.Parse(col[j].Value[dt.Rows[i]["CreateDate"].ToString()]) + int.Parse(dt.Rows[i]["Quantity"].ToString())).ToString();
    //                fg = false;
    //            }
    //        }
    ...
    //        if (i == 0 || fg)
    //        {
    //            data[dt.Rows[i]["CreateDate"].ToString()] = (Decimal.Parse(data[dt.Rows[i]["CreateDate"].ToString()]) + int.Parse(dt.Rows[i]["Quantity"].ToString())).ToString();
    //            col.Add(c);
    ...
    //    string sql = "SELECT DATE_FORMAT(CreateDate,'%Y-%m') AS 'CreateDate',COUNT(1) as 'Quantity', ProductName  from `visitorsreport`  " + where + "  GROUP BY DATE_FORMAT(CreateDate,'%Y-%m'),ProductName";
    ...
    //            if (col[j].Key == c.Key)
    //            {
    //                col[j].Value[dt.Rows[i]["CreateDate"].ToString()] = (Decimal.Parse(col[j].Value[dt.Rows[i]["CreateDate"].ToString()]) + decimal.Parse(dt.Rows[i]["Quantity"].ToString())).ToString();
    //                fg = false;
    //            }
    //        }
    ...
    //        if (i == 0 || fg)
    //        {
    //            data[dt.Rows[i]["CreateDate"].ToString()] = (Decimal.Parse(data[dt.Rows[i]["CreateDate"].ToString()]) + decimal.Parse(dt.Rows[i]["Quantity"].ToString())).ToString();
    //            col.Add(c);
